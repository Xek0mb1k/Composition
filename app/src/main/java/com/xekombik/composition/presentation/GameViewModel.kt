...
import com.xekombik.composition.data.GameRepositoryImpl
...
import com.xekombik.composition.domain.usecases.GenerateQuestionUseCase
import com.xekombik.composition.domain.usecases.GetGameSettingsUseCase
...
class GameViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun updateProgress() {
        ...
        _progressAnswers.value = String.format(
            context.resources.getString(R.string.score_info),
            countOfRightAnswers,
    ...
    private fun formatTime(millisUntilFinished: Long): String {
        ...
        return String.format("%02:%02", minutes, leftSeconds)
    }
